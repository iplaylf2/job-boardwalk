...
const runtimeOrigin = process.env["JOB_BOARDWALK_RUNTIME_ORIGIN"] ?? "http://127.0.0.1:4310";
const toolNames = {
    ...
    tools: [
      {
        ...
        description: "读取本地招聘工作区概览，用于信息整合和分析。",
      ...
      },
      {
        ...
        description:
          "打开或聚焦招聘平台窗口，供用户登录、完成验证或亲自操作平台。AI 助手不会投递、沟通或修改账户。",
