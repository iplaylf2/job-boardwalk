...
const jobLibraryResourceDescription =
  "读取岗位库第一页及分页元数据。岗位来自招聘平台页面，经规范化和跨平台合并；每个平台来源保留发现页面，以及可选的已采集职位描述和岗位原始链接，并包含个人中心观察到的感兴趣、沟通过、已投递和面试记录。";
const jobLibraryToolDescription =
  "分页读取岗位库，可搜索并按平台或跟进记录筛选。每个平台来源保留发现页面，以及可选的已采集职位描述和岗位原始链接，并包含个人中心观察到的感兴趣、沟通过、已投递和面试记录。";
