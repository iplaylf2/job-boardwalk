...
import { InvalidRequestError, readOptionalString, readRequiredString } from "./request.js";
...
export function readPlatformAccessObservation(
  ...
  return {
    ...
    platformId,
    ...readPlatformAccessAssessment(authenticationState, interruption, evidence),
  };
}
