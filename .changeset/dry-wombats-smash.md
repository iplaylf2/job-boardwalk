...
and follow-up view. You can filter for jobs with a collected description, jobs without one, or jobs
whose source information still needs to be completed. A new combined follow-up view brings
...
controls are visible. Job Boardwalk also distinguishes a navigation timeout from what it can still
